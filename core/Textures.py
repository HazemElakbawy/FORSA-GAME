...
def load_setup_textures():
    ...
    #
    loadHelper("FORSA-GAME/World Assets/start.png", 14)
    loadHelper("FORSA-GAME/World Assets/start-button.png", 15)

    loadHelper("FORSA-GAME/World Assets/porche_911.png", 1)
    loadHelper("FORSA-GAME/World Assets/world.png", 0)

    loadHelper("FORSA-GAME/World Assets/car-yellow.png", 2)
    loadHelper("FORSA-GAME/World Assets/car-red.png", 3)
    loadHelper("FORSA-GAME/World Assets/car-purple.png", 4)

    loadHelper("FORSA-GAME/World Assets/car-purple-2.png", 5)
    loadHelper("FORSA-GAME/World Assets/car-pink.png", 6)
    loadHelper("FORSA-GAME/World Assets/car-orange.png", 7)

    loadHelper("FORSA-GAME/World Assets/car-green.png", 8)
    loadHelper("FORSA-GAME/World Assets/car-blue.png", 9)
    loadHelper("FORSA-GAME/World Assets/car-red.png", 10)

    loadHelper("FORSA-GAME/World Assets/car-purple-2.png", 11)
    loadHelper("FORSA-GAME/World Assets/car-pink.png", 12)
    loadHelper("FORSA-GAME/World Assets/car-orange.png", 13)
